...
public class Student {
    ...
    public Student(String name, String no, Integer gender, String phone, String idCard, Integer isCollege, String address, Integer degree, LocalDate graduationDate, Integer clazzId) {
        this.name = name;
        this.no = no;
        this.gender = gender;
        this.phone = phone;
    ...
    public Student(Integer id, String name, String no, Integer gender, String phone, String idCard, Integer isCollege, String address, Integer degree, LocalDate graduationDate, Integer clazzId, LocalDateTime updateTime) {
        this.id = id;
        this.name = name;
        this.no = no;
        this.gender = gender;
