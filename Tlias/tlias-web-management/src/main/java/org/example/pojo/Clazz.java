...
public class Clazz {
    ...
    public Clazz(String name, String room, LocalDate beginDate, LocalDate endDate, Integer masterId, Integer subject) {
        this.name = name;
        this.room = room;
    ...
    public Clazz(Integer id, String name, String room, LocalDate beginDate, LocalDate endDate, Integer masterId, Integer subject) {
        this.id = id;
        this.name = name;
        this.room = room;
        this.beginDate = beginDate;
